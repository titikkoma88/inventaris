<?php 
	...
	$sql_rusak = mysqli_query($conn, "INSERT INTO `kondisi_rusak` 
									...
									`tanggal_bayar_gt`,
									`status_gt`) 
									VALUES (NULL, '$pinjam', 'Hilang', now(), '0000-00-00', '0')");

	$update_brg = mysqli_query($conn, "UPDATE barang SET kondisi = 'Hilang' WHERE id_barang = '$id_barang'");
	...
	if($sql_rusak){
		echo "
				<script>
					alert('Barang kembali dengan keadaan Hilang');
