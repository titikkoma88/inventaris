...
<body>
	<div class="navbar navbar-default navbar-fixed-top">
		<div class="navbar-header">
	      <a class="navbar-brand" href="#"><h4 style="color: white;">INVENTARIS</h4></a>
	    </div>
	    <ul class="nav navbar-nav">
	      <li><a href="#">Beranda</a></li>
	      <li><a href="#">Kontak Kami</a></li>
	      <li><a href="../user/logout.php" onclick="return confirm('Apakah anda ingin keluar?')">Keluar</a></li>
	    </ul>
	</div>
	<!-- TUTUP HEADER -->
	...
	<div class="hubungi-kami">
		<div class="col-sm-12" style="background-color: #1a9cb7; min-height: 645px;">
			...
			<form action="user-contact.php" method="POST">
			    ...
			    <label for="no_tel">Nomor Telephone</label>
			    <input type="text" id="lname" name="no_tel">
